              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    ...
                    {colourPickerVisible && <TwitterPicker className='mt-4' color={listColour} onChangeComplete={(color) => setListColour(color.hex)} />}
                  </div>
                  ...
                  <div className="mt-4">
                    <button
                      ...
                      onClick={() => {closeModal(); onSubmit(document.getElementById('newTaskName').value, listColour);}}
                    >
                      Create
                    </button>
                  </div>
